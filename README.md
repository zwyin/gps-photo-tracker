...
Download from [GitHub Releases](../../releases) (latest: v0.25.0):

| Platform | File |
|----------|------|
| macOS | `GPS-Photo-Tracker-v0.25.0-macos.zip` |
| Windows | `GPS-Photo-Tracker-v0.25.0-windows.zip` |
| Linux | `GPS-Photo-Tracker-v0.25.0-linux.tar.gz` |
